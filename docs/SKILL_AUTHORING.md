...
> 适用对象：新增或维护 `skills/**/SKILL.md` 的维护者
...
`skills/**/SKILL.md` frontmatter 是 skill metadata 的唯一事实源。
...
- 只能有一个 `scripts/*.js` 入口
- 实际执行入口统一通过 `skills/run_skill.js`
...
1. 创建 `skills/<category>/<skill-name>/SKILL.md`
