const I18N = {
  en: {
    ...
    'site.desc': 'Composable persona + style + 30 engineering skills with code graph intelligence, 4 native security domains, and a self-evolution forge. For Claude Code, Codex, Gemini CLI & OpenClaw.',
    'nav.how': 'How',
    ...
    'nav.spec': 'Spec',
    'nav.install': 'Install',
    'hero.badge': '4.6 — Code Graph Intelligence · Cross-platform hooks',
    'hero.title.1': 'Give your AI agent',
    'hero.title.2': 'a personality.',
    'hero.sub': 'Composable identity, style, and <b>30 engineering skills</b><br>— including <b>code graph intelligence</b>, <b>4 native security domains</b>, and a <b>self-evolution forge</b>.',
    ...
    'graph.desc': 'The <code>abyss</code> CLI — a Rust-powered code relationship graph that builds in <b>seconds</b>. Call graph, impact analysis, hotspot detection, change coupling. Four-language resolution (Go / TS / Python / Rust) benchmarked against SCIP at <b>≥98.5% precision</b>. <b>Zero cloud dependencies.</b>',
  ...
  zh: {
    ...
    'site.desc': '可组合的人格 + 风格 + 30 项工程技能，含 4 个原生安全领域、自我进化炼炉与代码关系图智能。支持 Claude Code, Codex, Gemini CLI 和 OpenClaw。',
    'nav.how': '原理',
    'nav.security': '安全',
    'nav.graph': '代码图',
    'nav.evolve': '进化',
    ...
    'nav.spec': '规范',
    'nav.install': '安装',
    'hero.badge': '4.6 — 代码关系图智能 · 跨平台 hooks',
    'hero.title.1': '给你的 AI 助手',
    'hero.title.2': '一个人格。',
    'hero.sub': '可组合的身份、风格，与 <b>30 项工程技能</b><br>—— 内含 <b>代码关系图智能</b>、<b>4 个原生安全领域</b> 与 <b>自我进化炼炉</b>。',
    'hero.browse': '浏览人格',
    'hero.submit': '提交你的',
    'hero.runs': '运行于',
    'how.label': '架构',
    ...
    'graph.desc': '<code>abyss</code> CLI —— 一个 Rust 驱动的代码关系图引擎，<b>秒级</b>构建。调用图、影响面分析、热点检测、变更耦合。四语言引用解析（Go / TS / Python / Rust），对标 SCIP 真值，<b>精度 ≥98.5%</b>。<b>零云端依赖。</b>',
