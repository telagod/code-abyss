const I18N = {
  en: {
    ...
    'site.desc': 'Composable persona + style + 29 engineering skills with 4 native security domains and a self-evolution forge. For Claude Code, Codex, Gemini CLI & OpenClaw.',
    'nav.how': 'How',
    ...
    'nav.spec': 'Spec',
    'nav.install': 'Install',
    'hero.badge': '4.5 — Dynamic Persona Loading · Core-only npm',
    'hero.title.1': 'Give your AI agent',
    'hero.title.2': 'a personality.',
    'hero.sub': 'Composable identity, style, and <b>29 engineering skills</b><br>— including <b>4 native security domains</b> and a <b>self-evolution forge</b>.',
  ...
  zh: {
    ...
    'site.desc': '可组合的人格 + 风格 + 29 项工程技能，含 4 个原生安全领域与自我进化炼炉。支持 Claude Code, Codex, Gemini CLI 和 OpenClaw。',
    'nav.how': '原理',
    'nav.security': '安全',
    'nav.evolve': '进化',
    'nav.personas': '人格',
    'nav.spec': '规范',
    'nav.install': '安装',
    'hero.badge': '4.5 — 人格动态加载 · 核心瘦包',
    'hero.title.1': '给你的 AI 助手',
    'hero.title.2': '一个人格。',
    'hero.sub': '可组合的身份、风格，与 <b>29 项工程技能</b><br>—— 内含 <b>4 个原生安全领域</b> 与 <b>自我进化炼炉</b>。',
    'hero.browse': '浏览人格',
    'hero.submit': '提交你的',
    'hero.runs': '运行于',
    'how.label': '架构',
