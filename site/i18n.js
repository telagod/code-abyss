const I18N = {
  en: {
    ...
    'nav.spec': 'Spec',
    'nav.install': 'Install',
    'hero.badge': '5.0 — Agent OS · Mythos Kernel · Voice Card',
    ...
    'install.graph': 'Code graph (separate abyss CLI):',
  ...
  zh: {
    ...
    'nav.spec': '规范',
    'nav.install': '安装',
    'hero.badge': '5.0 — Agent OS · 神话内核 · 声音卡',
    ...
    'install.alt': '或',
    'install.tip': '自由混搭：',
    'install.graph': '代码图（独立 abyss CLI）：',
    'footer.submit': '提交人格',
    'footer.gallery': '画廊',
    'submit.label': '社区',
    'submit.title': '提交人格预设',
